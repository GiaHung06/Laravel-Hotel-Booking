...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">{{__('Chỉnh sửa Tour')}}</h4>
            ...
            <form role="form" action="{{URL::to('/update-tour/'.$tour->tour_id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex no-block align-items-center">
                        <h4 class="card-title">{{__('Chỉnh sửa TOUR')}}</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="control-label col-form-label">Mô tả tiếng Việt</label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="control-label col-form-label">Mô tả tiếng Anh</label>
                                <textarea class="form-control" id="exampleTextarea2" rows="4"
                                    placeholder="{{__('Desc Here')}}"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">Tổng quan bằng tiếng Việt</label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">Tổng quan bằng tiếng Anh</label>
                                <textarea class="form-control" id="exampleTextarea2" rows="4"
                                    placeholder="{{__('Overview Here')}}"
                                    ...
                                    <div class="controls">
                                        <div class="entry input-group ">
                                            ...
                                            <textarea class="form-control clone col-8" name="tour_day_1"
                                                placeholder="Ngày 1" required>{{$tour_schedule->tour_schedule_content}}</textarea>
