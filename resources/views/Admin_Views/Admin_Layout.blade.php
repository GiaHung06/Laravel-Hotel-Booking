...
?>
                    ...
                    {{-----------------------------------------------------------------------------------------}}
                    {{--Start tour manager--}}
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ TOUR')}}</span></li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map-marker-radius"></i><span class="hide-menu">{{__('Điểm Đến')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-destination')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Danh sách điểm đến')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-firefox"></i><span class="hide-menu" >{{__('LOẠI HÌNH TOUR')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map"></i><span class="hide-menu">{{__('TOURS')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/add-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm tour')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Danh sách tour')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ BOOKING')}}</span></li>
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ TOUR CUSTOM TOUR')}}</span></li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-save-all"></i><span class="hide-menu">{{__('CONTRACTS')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                    ...
                    {{--End booking manager--}}
                    {{--start staff manager--}}
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ NHÂN SỰ')}}</span></li>
