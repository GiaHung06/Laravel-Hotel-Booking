            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>{{__('LOẠI HÌNH DU LỊCH')}}</h3>
                        <p>{{__('Thưởng thức nó theo cách của bạn')}}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 col-sm-12" style="padding-top:80px">
        <div class="container">
            <h2 class="wow fadeInUp" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;text-align: center;font-family: 'Philosopher';font-weight: bolder">
                {{__('Chọn chuyến đi của bạn với Vietrip trong các chuyên mục của chúng tôi, chúng tôi có những lựa chọn tốt nhất và phù hợp nhất cho bạn, từ tuần trăng mật lãng mạn và thơ mộng, những chuyến du lịch thư giãn nhưng mạo hiểm cùng bạn bè hoặc gia đình, đến những chuyến du lịch văn hóa và truyền thống đáng nhớ để khám phá cuộc sống của quá khứ … Tất cả các lựa chọn phụ thuộc vào bạn, vào ngân sách và sở thích của bạn.')}}
            </h2>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="row align-items-center">
                        <div class="col-lg-10 ">
                            ...
                            <h3 style="color: white; font-size: 50px;font-weight:bolder ">TẠO CHUYẾN ĐI CỦA CHÍNH MÌNH</h3>
                            <a  href="{{URL::to('wishlist')}}" class="genric-btn danger-border e-large" style="border-radius: 5px;" >Tủy chỉnh chuyến đi</a>
                        </div>
                    </div>
                </div>
            </div>
