        ...
        <div class="section-top-border">
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <h3 class="mb-30"><b>Hãy bắt đầu tùy chỉnh Tour du lịch của bạn</b></h3>
                                ...
                                <div class="col-6">
                                        ...
                                        <div class="input_field">
                                            <select name="custom_destination">
                                                ...
                                                <option value="Ha Long" selected>{{__('Hạ Long')}}</option>
                                                <option value="Ninh Binh">{{__('Ninh Bình')}}</option>
                                                <option value="Nha Trang">{{__('Nha Trang')}}</option>
                                                <option value="Da Nang">{{__('Đà Nẵng')}}</option>
                                                <option value="Da Lat">{{__('Đà Lạt')}}</option>
                                                <option value="Phu Quoc">{{__('Phú Quốc')}}</option>
                                                <option value="Ha Noi">{{__('Hà Nội')}}</option>
                                                <option value="Sai Gon">{{__('Sài Gòn')}}</option>
                                            </select>
                                        </div><br><br>
                ...
                <div class="col-lg-3 col-md-4 mt-sm-30">
                    <div class="single-element-widget">
                        ...
                        <h3 class="mb-30"><b>{{__('CÁC BƯỚC')}}</b></h3>
                        <sup>{{__('thuận tiện và nhanh chóng')}}</sup>
                        <div class="how-it-work-item">
                            <ul>
                                <li class="row">
                                    <div class="work-number">1</div>
                                    <p>{{__('Gửi yêu cầu của bạn')}}</p>
                                </li>
                                <li class="row">
