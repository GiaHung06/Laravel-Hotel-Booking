    ...
    <div class="col-md-12 col-sm-12" style="padding-top:80px">
        <div class="container">
            <h2 class="wow fadeInUp" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;text-align: center;font-family: 'Philosopher';font-weight: bolder">
                {{__('Bạn sẽ dễ dàng thực hiện một chuyến đi với tất cả những ý tưởng được chúng tôi gợi ý giúp chuyến phiêu lưu của bạn trở thành một khoảnh khắc khó quên trong đời…')}}
            </h2>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="row align-items-center">
                        <div class="col-lg-10 ">
                                ...
                                <a href="{{URL::to('wishlist')}}" class="genric-btn danger-border e-large" style="border-radius: 5px;" >Tùy chỉnh chuyến đi</a>
                        </div>
                    </div>
                </div>
            </div>
