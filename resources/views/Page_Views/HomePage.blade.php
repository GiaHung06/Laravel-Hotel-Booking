            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>{{__('Điểm Đến Phổ Biến')}}</h3>
                        <p>{{__('Bạn sẽ dễ dàng thực hiện một chuyến đi với tất cả những ý tưởng được chúng tôi gợi ý giúp chuyến phiêu lưu của bạn trở thành một khoảnh khắc khó quên trong đời…')}}</p>
                    </div>
                </div>
            </div>
            <div class="row ">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="newsletter_text">
                                <h4>{{__('Theo dõi Bản tin của chúng tôi')}}</h4>
                                <p>{{__('Đăng ký bản tin để nhận ưu đãi và về những địa điểm mới để khám phá.')}}</p>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="mail_form">
        ...
        <div class="container">
            <div class="thumbnail">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section_title text-center mb_70">
                            <h3>{{__('Loại Tour Phổ Biến')}}</h3>
                            <p>{{__('Chọn chuyến đi của bạn với Vietrip trong danh mục của chúng tôi, chúng tôi có những lựa chọn tốt nhất và phù hợp nhất cho bạn, từ lãng mạn và thơ mộng....')}}</p>
                        </div>
                    </div>
                </div>
                <div class="row">
