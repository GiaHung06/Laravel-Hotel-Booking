                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class=""
                                                    href="{{URL::to('type-of-tour')}}">{{__('Loại Nghỉ Dưỡng')}}</a>
                                            </li>
                                            <li><a class="" href="{{URL::to('post')}}">{{__('Bài Đăng')}}</a></li>
                                            <li><a class="" href="{{URL::to('wishlist')}}">{{__('Đặt Tour')}}</a>
                                            </li>
                                            {{--<li>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                <li><a href="{{URL::to('contact/')}}">{{__('Về chúng tôi')}}</a></li>
                                <li><a href="{{URL::to('destination/')}}"> {{__('Điểm đến')}}</a></li>
                                <li><a href="{{URL::to('type-of-tour/')}}">{{__('Loại tour')}}</a></li>
                                <li><a href="{{URL::to('post/')}}"> {{__('Bài đăng')}}</a></li>
                                <li><a href="{{URL::to('wish-list/')}}"> {{__('Đặt tour')}}</a></li>
                ...
                <div class="serch_form">
                    <form action="{{URL::to('search-2')}}" method="get">
                        <input name="search_content" type="text"
                            placeholder="{{__('Tìm Kiếm or Typetour')}}">
